	...
	<%
		...
		while (rs.next()) {
			...
			studentlist.add(new StudentItem(rs.getString("name"), rs
					.getString("college_alloted"), rs.getInt("student_rank"),rs.getString("email"),rs.getString("pre1"),rs.getString("pre2"),rs.getString("pre3")));
						...
						<tbody>
							<%
								for (int i = 0; i < studentlist.size(); i++) {
									...
									out.print("</td>");
									out.println("<td class=\"mdl-data-table__cell--non-numeric\">");
									out.println(studentlist.get(i).p1);
									out.print("</td>");
									out.println("<td class=\"mdl-data-table__cell--non-numeric\">");
									out.println(studentlist.get(i).p2);
									out.print("</td>");
									out.println("<td class=\"mdl-data-table__cell--non-numeric\">");
									out.println(studentlist.get(i).p3);
									out.print("</td>");
